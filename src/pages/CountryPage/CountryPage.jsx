          ...
          <div className="country-page-context-container">
            <div className="flex w-full max-w-52 flex-col gap-2">
              ...
              <p className="standard-text">
                ...
                {!excludedCountries.find((c) => c.code === country[0].cca3).excluded.includes('nativeName')
            ...
            <div className="flex w-full max-w-60 flex-col gap-2">
              ...
              <p className="standard-text">
                ...
                {!excludedCountries.find((c) => c.code === country[0].cca3).excluded.includes('currencies')
              ...
              <p className="standard-text">
                ...
                {!excludedCountries.find((c) => c.code === country[0].cca3).excluded.includes('languages')
              ...
              {loading ? (
                ...
                <div className="flex flex-wrap gap-2">
                  {filteredBorderCountries.map((borderCountry) => (
                    <Link to={`../${borderCountry.cca3}`} className="border-country" key={borderCountry.cca3}>
